...
import 'package:dalilaq/src/data/models/UserModel.dart';

import 'package:dalilaq/src/data/repository/UserRebository.dart';
...
class UserService extends UserRebository {
  ...
  @override
  Future<UserModel> regNewUser(String name, String pass, String email,
